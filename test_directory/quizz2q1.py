# Create a function that takes a string representing a mathematical expression (like ”2+3*4”), removes
# all operators (’+’, ’-’, ’*’, ’/’), and returns a list of the unique digits that remain, sorted in descending
# order.
